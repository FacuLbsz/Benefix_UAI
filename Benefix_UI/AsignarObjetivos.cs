...
namespace Genesis
{
    public partial class AsignarObjetivos : Form
    {
        ...
        private void AsignarEmpleados_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(this.asignarButton, "Asigna el objetivo seleccionado al equipo");
            toolTip1.SetToolTip(this.desasignarButton, "Desasigna el objetivo seleccionado al equipo");
